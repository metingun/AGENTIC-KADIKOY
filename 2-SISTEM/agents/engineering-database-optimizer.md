...
|------|-------|
| **Kanal** | Master + Ops |
| **Tetikleyici** | BE task'ta şema/migration/sorgu; OPS'ta DB container/infra |
| **Sıra** | BE **adım 4**; OPS **adım 3** |
| **Sonraki** | `@kadikoy-data-engineer` (stream varsa) veya `@kadikoy-code-reviewer` |

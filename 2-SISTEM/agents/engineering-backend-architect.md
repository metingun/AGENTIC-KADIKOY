...
| **Tetikleyici** | Her `BE-` task |
| **Sıra** | BE pipeline **adım 3** |
| **Önceki** | `@kadikoy-software-architect` (yeni modülde) |
| **Sonraki** | `@kadikoy-database-optimizer` (DB varsa) → `@kadikoy-code-reviewer` |

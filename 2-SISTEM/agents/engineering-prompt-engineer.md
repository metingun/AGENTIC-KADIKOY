...
| Alan | Değer |
|------|-------|
| **Kanal** | Master + Ops (global kanca G1) |
| **Tetikleyici** | Her oturum başı; BUSINESS/TASKS/OPS/HANDOFF okunmadan önce; her agent brief yazılmadan önce |
| **Sıra** | Her zaman **1.** (Optimization Architect ile birlikte) |
| **Sonraki** | Task tipine göre pipeline devam eder |

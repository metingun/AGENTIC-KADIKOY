...
| Alan | Değer |
|------|-------|
| **Kanal** | Master + Ops (global kanca G2) |
| **Tetikleyici** | Her oturum başı; her LLM/API çağrısı öncesi |
| **Sıra** | Her zaman **2.** (Prompt Engineer'dan hemen sonra) |
| **Görev** | Token bütçesi, retry cap (max 3), timeout, circuit breaker |

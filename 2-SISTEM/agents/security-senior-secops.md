...
|------|-------|
| **Kanal** | Master + Ops |
| **Tetikleyici** | Her kod submission; auth/rol/PII değişikliği; `push yap`; OPS pipeline |
| **Sıra** | FE **adım 8**; BE **adım 9**; OPS **adım 2**; push öncesi |
| **Görev** | Secret taraması (her zaman); auth değişikliğinde onay |

...
| **Tetikleyici** | Proje başı; belirsiz BE gereksinimi; yeni domain kuralı |
| **Sıra** | Proje başı **adım 1**; BE pipeline **adım 1** (belirsizlik varsa) |
| **Sonraki** | `@kadikoy-software-architect` |

...
### Forma Estetik QA (FE task — zorunlu kontrol)
UI Designer vizyon bloğu ve HANDOFF'taki estetik yön ile karşılaştır:
- [ ] **Generic AI slop** görünümü var mı? (mor gradient+beyaz, Inter/Roboto, Bootstrap/MUI default) → FAIL
- [ ] Estetik vizyon bloğu (`🎯 Estetik Yön`) kodda hissediliyor mu?
- [ ] En az 2 tema çalışıyor mu? (screenshot: light + dark)
- [ ] Tipografi cesur mu? Yasak font yok mu?
- [ ] Hover animasyonları görünür mü? (transform+opacity, sadece renk değil)
- [ ] Mobile screenshot bozulma yok mu?
- [ ] Dashboard'da chart renkleri palette'ten mi?
- [ ] WCAG AA kontrast şüphesi var mı?

Generic görünüm = otomatik FAIL (Evidence Collector 3–5 issue kuralı).
